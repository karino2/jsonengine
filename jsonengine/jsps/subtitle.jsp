...
function onTextsComming(result) {
	...
	for(var i = 0; i <texts.length; i++){
		...
		var target = $('<div/>').addClass("col-md-5").append(targetTextArea);
		var original = $('<div/>').addClass("col-md-5").append($('<textarea />').addClass("original").val(texts[i].original).attr("disabled", "disabled"));
		var submit = $('<a href="javascript:void(0)" class="btn btn-default"><i class="glyphicon glyphicon-ok"></i></a>').click(function() {
		...
		div.append(original);
		div.append(target);
		div.append($('<div/>').addClass("col-md-2").append(submit));
		holder.append(div);		
	}
...
<div class="container" id="homeDiv">
  ...
  <div class="input-append">
    <select class="col-md-5" onchange="onChangeSrt()" id="srtList"></select>
